 ...
 */
final class Version20200716110655 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, content_message LONGTEXT NOT NULL, date_message DATETIME NOT NULL, email_message VARCHAR(255) NOT NULL, sender_message VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
